...
//  Fireworks
//
//  Created by Christopher Endress on 12/9/23.
//
...
class GameScene: SKScene {
  ...
  private func gameOver() {
    ...
    gameLabel.text = "Game Over! You scored \(score)!"
    gameLabel.position = CGPoint(x: frame.midX, y: frame.midY)
    addChild(gameLabel)
  }
  ...
  func explode(firework: SKNode) {
    if let emitter = SKEmitterNode(fileNamed: "explode") {
      ...
      let emitterDuration: TimeInterval = 1
